    ...
    <SectionContainer>
      <section className="py-6 px-4 flex flex-col lg:flex-row gap-2 lg:items-center lg:h-[450px] bg-[#A6A7AA] rounded-lg">
        <div className="flex flex-col  gap-3">
          <Heading1 className="text-center lg:text-left text-4xl font-bold mb-4">
            Support Conservation with Every Purchase
          </Heading1>
          <Paragraph className="text-center lg:text-left leading-8">
            Every item you buy directly supports our marine conservation
            projects and empowers local communities through capacity building
            and education. Wear your impact.
          </Paragraph>
        ...
        {/*<div className="lg:w-[60%] h-[250px] lg:h-full relative overflow-hidden">
          <AppImage
            ...
            src="https://res.cloudinary.com/dl0cuzahq/image/upload/q_auto/f_auto/v1775342082/Seminar2_wwgubf.webp"
            fill
            objectFit="contain"
          />
        </div>*/}
