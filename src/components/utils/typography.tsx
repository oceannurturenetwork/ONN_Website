...
const ListItem = React.forwardRef<HTMLLIElement, ListProps>(
    ({ className, ...props }, ref) => {
        return <li className={cn('text-xs lg:text-base', className)} ref={ref} {...props} />;
    },
);
...
>(({ className, ...props }, ref) => (
    <p ref={ref} className={cn('leading-8 text-xs lg:text-base', className)} {...props} />
));
    ...
    ({ className, ...props }, ref) => {
        return (
            <h2
                ref={ref}
                className={cn(
                    'scroll-m-20 text-xl lg:text-2xl font-bold tracking-tight',
                    className,
                )}
                {...props}
            />
    ...
    ({ className, ...props }, ref) => {
        return (
            <h3
                ref={ref}
                className={cn(
                    'scroll-m-20 text-md lg:text-xl font-semibold tracking-tight',
                    className,
                )}
                {...props}
            />
