    ...
    <>
      ...
      <Stats
        cards={[
          {
            title: "66%",
            description: "Wave height reduction by mangroves",
            icon: Shield,
          },
          {
            title: "$23B",
            description: "Annual storm protection value from wetlands",
            icon: Shield,
          },
          {
            title: "50%",
            description: "Global loss of coastal ecosystems",
            icon: Shield,
          },
        ]}
      />
      ...
      <FlipCards cards={cards} title="Implementing nature-based solutions" />
      {/* <Images images_list={[
...
const cards = [
  {
    ...
    image:
      "https://res.cloudinary.com/dl0cuzahq/image/upload/q_auto/f_auto/v1775342080/pexels-ron-lach-9037221_xd9yef.webp",
    backText:
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dl0cuzahq/image/upload/q_auto/f_auto/v1775342079/pexels-quang-nguyen-vinh-222549-33326449_tbkldx.webp", // Replace with your actual path
    backText:
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dl0cuzahq/image/upload/q_auto/f_auto/v1775342083/pexels-twilightkenya-12079507_i4st1o.webp", // Replace with your actual path
    backText:
