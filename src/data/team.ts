...
const directors: TeamMemberType[] = [
  // {
  //   name: "Dennis Otieno",
  //   position: "Co-Founder & Board Chairman",
  //   email: "",
  //   bio: "Dennis Otieno is a marine research scientist with expertise in oceanography, climate-related marine science, the blue economy, and fisheries. With over five years of experience in marine and fish ecology, he focuses on the dynamics of marine ecosystems and has one year of experience in financial management. His work includes monitoring and evaluating marine conservation and aquaculture projects, supporting marine spatial planning, and strengthening blue economy value chains. Additionally, he has facilitated capacity-building initiatives for coastal communities and youth-led blue economy enterprises. Dennis’s technical skills encompass oceanographic data collection using multibeam sonar, ASVs, ROVs, satellite data processing, time-series analysis, remote sensing, GIS data analysis, R programming, project management, and budgeting. The heart of his work lies in unraveling the complexities of oceanography, climate impacts, the blue economy, and fisheries, and applying these insights to sustainable management. He aspires to contribute to ecosystem-based fisheries management by incorporating oceanographic data into policy development, advancing the resilience and sustainability of marine ecosystems for future generations.",
  //   portrait:
  //     "https://res.cloudinary.com/dyo0ezwgs/image/upload/v1752648106/onn/WhatsApp_Image_2025-07-15_at_15.56.45_y3iww2.jpg",
  //   // "https://res.cloudinary.com/dyo0ezwgs/image/upload/v1746808496/onn/WhatsApp_Image_2025-05-08_at_21.55.25_1_tynijj.jpg"
  // },
  {
    name: "Maorine Okeri",
    position: "Co-Founder & Board Cordinator",
    email: "",
...
const leadership: TeamMemberType[] = [
  ...
  {
    name: "Nicole Mumbi",
    position: "Partnership and Mobilization Director",
    email: "",
  ...
  },
  {
    ...
    email: "",
    bio: "Angel Mutai is a passionate environmental communicator and creative strategist dedicated to advancing marine conservation through impactful storytelling and community engagement. She holds a Diploma in Broadcast Journalism from Kenya Coast National Polytechnic, where she honed her skills in media, public communication, and content creation. At ONN, Angel leads communication and outreach efforts by  managing social media platforms, campaigns, and brand visibility. She plays a key role in raising public awareness about ocean health, blue economy opportunities, and sustainable coastal living. Angel is deeply committed to making environmental messages accessible and inspiring, especially to youth and coastal communities. Through creative content, media partnerships, and grassroots engagement, she amplifies the voices and actions that nurture a resilient and thriving ocean.",
    // "Nicole is a dedicated marine conservationist with an educational background in applied biology. She intends on working to protect the marine ecosystems and to promote sustainable practices.She Passionate about education and outreach in order to  raise awareness about marine conservation and inspire future generations of environmental stewards. At ONN she establishes relationships with potential partners, such as other organizations, donors, government agencies, or corporate entities, to support the organization’s mission and objectives as well as to engage and maintain relationships with a variety of stakeholders, including community leaders, donors, government officials, and other partners, ensuring clear communication and collaboration.",
    portrait:
      "https://res.cloudinary.com/dyo0ezwgs/image/upload/v1752648105/onn/WhatsApp_Image_2025-07-15_at_12.27.37_eippxg.jpg",
...
const advisors: TeamMemberType[] = [
  {
    ...
    position: "Advisor",
    email: "",
    bio: "Dr. Sebastian Krieger is a data scientist with a background in oceanography and physics, bringing over 20 years of experience in applying advanced computational techniques to drive evidence-based decision-making. His expertise spans ocean hydrodynamic modeling, satellite remote sensing, and machine learning. Holding a Ph.D. in Physical Oceanography, Dr. Krieger is passionate about bridging the gap between science and community, and is dedicated to mentoring the next generation of leaders focused on creating a sustainable future.",
    portrait:
      "https://res.cloudinary.com/dyo0ezwgs/image/upload/v1744978001/onn/IMG-20250418-WA0000_q6ah3p.jpg",
  },
  {
    name: "Prof. Morgan A. McClure",
    position: "Advisor",
    email: "",
    bio: "Morgan A. McClure is a retired wetland scientist with specific interests in aquatic ecology He has his undergraduate degree in biology from the Citadel, the Military College of South Carolina as well as advanced degrees in biology (The Citadel, Military College of South) and aquatic entomology (Clemson University).  He received his professional certification as a professional Wetland Scientist (PWS) in 1992. He has nearly 45 years of experience as a government biologist (11 years) and a private environmental consultant (20 years) in the United States. He is now in Australia doing pro bono work with land care organizations for water quality improvement. Over the years, he has served as an adjunct professor teaching  undergraduates Environmental Science (9 years) and as an environmental advocate  for various US  and now Australian environmental NGOs to include National Audubon, the Nature Conservancy, National Wildlife Federation, Australian Conservation Foundation, the Canberra, Australia Conservation Council and others. ",
    portrait:
      "https://res.cloudinary.com/dyo0ezwgs/image/upload/v1745961835/onn/WhatsApp_Image_2025-04-20_at_06.49.18_wkdxuq.jpg",
  },
];
